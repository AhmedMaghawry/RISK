...
public class AStarAgent extends AIAgent {
	...
	private int evaluate_h(NState state) {
		int heuristic_h = 0;
		/*
		 * if (state.attack == null) System.out.println("HRRRRRRRRRRRRR " +
		 * state.place.getKey() + " Place " + state.place.getValue() +
		 * " Attack From " + state.turn);
		 */
		...
		/*
		 * if (num == 0) { heuristic_h = Integer.MAX_VALUE; return heuristic_h;
		 * }
		 */
